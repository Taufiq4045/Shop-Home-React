...
{ 
  const imgsrc="https://aheadworks.com/media/catalog/product/s/m/smart_one_step_checkout_1.png"
   ...
   <div className="cardContainer" >
       {items.map(item=>{
         //adding the callback to props
          return <Product value={item} key={item.name} parentCallBack={callBackSet} />
       })}
       </div>
    </div>
  );
